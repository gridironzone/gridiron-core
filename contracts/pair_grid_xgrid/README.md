# Gridiron GRID-xGRID pair

This pool is implementation of pair bonded template. It allows to process GRID-xGRID swap operations via Gridiron Staking.
...
Perform a swap via Gridiron Staking contract.
