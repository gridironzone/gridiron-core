...
use gridiron::maker::{Config, MigrateMsg};
...
pub(crate) fn migrate_from_v1(deps: DepsMut, msg: &MigrateMsg) -> StdResult<()> {
    ...
    let mut new_config = Config {
        ...
        grid_token: token_asset_info(old_config.grid_token_contract),
        ...
        pre_upgrade_grid_amount: old_config.pre_upgrade_grid_amount,
...
pub(crate) fn migrate_from_v120(deps: DepsMut, msg: MigrateMsg) -> StdResult<()> {
    ...
    let mut new_config = Config {
        ...
        grid_token: cfg_v120.grid_token,
        ...
        pre_upgrade_grid_amount: cfg_v120.pre_upgrade_grid_amount,
        second_receiver_cfg: None,
    };
