...
pub enum QueryMsg {
    ...
    TokenInfo {},
    /// Returns who can mint xGRID and the hard cap on maximum tokens after minting.
    ...
    /// AllAccounts returns all the accounts that have xGRID balances. Supports pagination.
...
/// Queries current user's voting power from the xGRID contract by timestamp.
///
