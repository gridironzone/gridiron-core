    ...
    C::QueryT: CustomQuery + DeserializeOwned + 'static,
{
    let contract = Box::new(ContractWrapper::new_with_empty(
        gridiron_shared_multisig::contract::execute,
        gridiron_shared_multisig::contract::instantiate,
        gridiron_shared_multisig::contract::query,
    ));
